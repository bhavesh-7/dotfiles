...
# zstyle ':omz:update' mode remin[[ -o interactive ]] || returnder  # just remind me to update when it's time
...
__conda_setup="$('/home/bhavesh/Applications/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
