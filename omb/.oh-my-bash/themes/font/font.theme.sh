...
function _omb_theme_PROMPT_COMMAND() {
  ...
  local RC="$?"
    ...
    PS1="\n${fedoraIcon} >> $python_venv${hostname} ${_omb_prompt_bold_gray}>> $(clock_prompt)${_omb_prompt_bold_gray}>> [${_omb_prompt_bold_teal}\W${_omb_prompt_bold_gray}]${_omb_prompt_bold_green} $(scm_prompt_char_info)\n${ret_status}→ ${_omb_prompt_normal}"
}
greetings
